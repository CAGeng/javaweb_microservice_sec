...
-- ----------------------------
-- Table structure for student2s
-- ----------------------------
DROP TABLE IF EXISTS `student2s`;
...
-- ----------------------------
-- Records of student2s
-- ----------------------------
BEGIN;
INSERT INTO `student2s` VALUES (1, 'sft');
INSERT INTO `student2s` VALUES (2, 'ljq');
INSERT INTO `student2s` VALUES (3, 'sbt');
COMMIT;
...
-- 插入数据
INSERT INTO person (id, username, nickname)
VALUES ('1', 'sft', 'sfthaha');

SELECT nickname FROM Person WHERE nickname = 'sfthaha';
